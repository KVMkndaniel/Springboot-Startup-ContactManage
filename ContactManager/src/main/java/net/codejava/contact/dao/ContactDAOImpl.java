...
public class ContactDAOImpl implements ContactDAO {
	...
	public ContactDAOImpl(DataSource datasourse) {
	...
	public int update(Contact contact) {
		...
		return jdbcTemplate.update(sql,contact.getName(),contact.getEmail(),contact.getAddress(),contact.getPhone(),contact.getContact_id());
	}
